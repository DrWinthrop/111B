...
\checkpoint{Resonance Condition and Symmetry}{How can you tell when you have found the resonance condition in this mode? Should there be any symmetry? If so, how should it be symmetrical? Along what axis should the symmetry be found?}
...
\checkpoint{Setup Pictures}{Show the above pictures you have setup to the professor or GSI.}
...
\checkpoint{CW Setup}{Show the professor or GSI your CW setup with picture on scope. What is the line width for Glycerin? For water?}
...
\checkpoint{Scanning Frequency}{Show the professor or GSI your setup for the day after completing this procedure. What frequencies did you record? Was the scanning frequency range near 90 kHz as expected?}
...
\checkpoint{Mn Sample Traces}{Show the above trace to the professor or GSI for sign off.}
