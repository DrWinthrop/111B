...
\begin{enumerate}
    \item \textbf{Muon Lifetime (Current Page)}
    
    \item \href{http://experimentationlab.berkeley.edu/node/86}{\textbf{Exponential Probability Distributions}}
    
    \item \href{http://experimentationlab.berkeley.edu/node/88}{\textbf{LabView Programs Controlling NI Digitizer}}
    
    \item \href{http://experimentationlab.berkeley.edu/EAX}{\textbf{Error Analysis Exercise}}    
...
\begin{minipage}{0.18\textwidth}
    \href{http://experimentationlab.berkeley.edu/sites/default/files/images/MUO_Pwr_3562.png}{\includegraphics[width=\linewidth,keepaspectratio]{images/MUO_Pwr_3562.png}}
    \caption{High voltage power supplies for top \& bottom photomultiplier tubes with the black base of the top photomultiplier tube shown. See larger image \href{http://experimentationlab.berkeley.edu/sites/default/files/images/MUO_Pwr_3562.png}{\textbf{here}}}
\end{minipage}
...
\begin{itemize}
    \item high voltage power supplies for the photomultiplier tubes. The high voltage of the photomultiplier tube normally is left on and is NOT adjusted by the student. See the staff in the 111-LAB. These photomultiplier tubes are irreplaceable. Do not mess with them.\emph{\textbf{Under no circumstances should the high voltage exceed 2200 V!}}

    \item two photomultiplier tubes (bottom one not visible from 275)
    
    \item one large liquid scintillator with 500 kg of doped mineral oil with opaque baffle in the middle
...
\begin{itemize}
    ...
    \item National Instruments Digitizing Card \# NI-5114 (already set up with the computer at your station)
    
    \item Labelled BNC's connecting to data acquisition channels on NI-5114  

    \item Ends of cables from 286
...
\begin{enumerate}
    ...
    \begin{itemize}
        \item If the pulses coming into the digitizer card are negative, \textbf{Flip Polarity} should be enabled.
...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item Configure the CD output of the Delay Generator to send out a 100 ns pulse some time after the AB pulse. Remember that you set the AB pulse to be sent 1 $\mu$s after the internal trigger, so setting the CD pulse to begin at 3 $\mu$s will correspond to a time difference of 2 $\mu$s between the pulses. Pick the amplitude and polarity to match that of pulse AB.
