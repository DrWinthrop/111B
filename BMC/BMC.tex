...
\endminipage \hfill
\minipage{0.32\textwidth}
  \href{http://experimentationlab.berkeley.edu/sites/default/files/images/Microscope.png}{\includegraphics[width=\linewidth,keepaspectratio]{images/Microscope_new.png}}
  \caption{Microscope Legend \\
  \href{http://experimentationlab.berkeley.edu/sites/default/files/images/Microscope.png}{Click here to see larger picture}}
...
\begin{itemize}
    \item Learn how to use a microscope (focus on an image, achieve K\"ohler illumination, prepare slides)
...
\begin{enumerate}
    ...
    \item 1.0 $\mu$m PolyStyrene \# PS03N
...
\end{minipage}
\end{figure}
Description: Many proteins may be easily and stably absorbed to hydrophobic, non-functionalized microspheres. Divinylbenzene (DVB) confers additional solvent and heat resistance to the crosslinked spheres. PS and P(S/DVB) microspheres are available in four standard amounts. Use  \href{http://physics111.lib.berkeley.edu/Physics111/Reprints/BMC/Colloid\%20Data\%20Sheets.pdf}{\textbf{data sheets for the beads}} to examine the properties of the beads you use in this experiment. The beads, along with their corresponding data sheets, may change from shipment to shipment. You should ask 111B staff to retrieve the new data sheets from the CO2 laser refrigerator if the linked data sheets are outdated. Note that not all data sheets are available. \\

You will prepare wet mount slides of polystyrene beads and onion epidermis peels to view on the light microscope pictured above (More specific explanations are found below). This is an inverted compound microscope, called inverted because the lenses are \emph{below} the stage, and the light source above. The microscope is outfitted with four objective lenses: 5x, 10x, 20x, and 40x. The most challenging technique you will learn is the proper adjustment of the condenser turret and iris diaphragms to achieve good bright-field K\"ohler illumination and dark-field illumination. It is worth learning this technique carefully, as it makes a big difference in the contrast and sharpness of your image. Aside from initial calibration and occasional high-power measurements, you will find the 20x objective and dark-field illumination most useful.
...
\begin{enumerate}
    ...
    \item Get your \href{http://experimentationlab.berkeley.edu/sites/default/files/writeups/BMC_Signatures.pdf}{\textbf{Mid Lab}} signed off. This should be the end of day 2.
\end{enumerate}
...
\checkpoint{Dark-Field Illumination}{Read Mid-Lab Questions Part 1 question numbers 3 and 4. When you have the answer / set up dark-field illumination, call over a GSI or professor to sign you off. Note: There are two signatures for dark field illumination -- it's important that your technique is excellent here.}
...
\checkpoint{Data Analysis Additional Questions}{Discuss a few of the previous questions with a GSI before moving on.}
...
\checkpoint{Cellular Motion Additional Questions}{Discuss a few of the previous questions with a GSI to demonstrate your understanding.}
...
\begin{itemize}
    ...
    \item What is the amount of work needed to transport a vesicle from the perimeter of the cell to the center? (You can calculate this quantity based on the Stokes-Einstein Equation using the particle size and viscosity of the cytosol that you have already determined).
...
\begin{enumerate}
    ...
    \item D. Murphy, Fundamentals of Light Microscopy and Electronic Imaging, Wiley (2001). More than you ever wanted to know about microscopes. The sections on K\"ohler illumination (page 6) and dark-field microscopy (page 112) are particularly relevant.
