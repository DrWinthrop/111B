...
\minipage[t]{0.262\linewidth}
  ...
  \label{fig:IMG_4088.JPG}
\endminipage
\end{figure}

\begin{figure}[H]
\captionsetup{justification=centering}
\minipage[t]{0.451\linewidth}
...
\minipage[t]{0.480\linewidth}
  ...
  \caption{SRS DS345 Synthesized Function Generator \\ \href{http://experimentationlab.berkeley.edu/sites/default/files/images/LLSimage_SRS_DS345.jpg}{Click here to see larger picture}}
  \label{fig:LLSimage_SRS_DS345.jpg}
\endminipage\hfill
\minipage[t]{0.510\linewidth}
  ...
  \caption{Tektronix 2215 Oscilloscope\\
...
\signatures \hyperlink{Fourier Components}{1} \hyperlink{Slope/Oct and Time Constant}{2} \hyperlink{1/f Noise}{3} \hyperlink{Capacitive Noise}{4} \hyperlink{Experiment Nine}{5} 
...
\begin{enumerate}
    \item \href{http://physics111.lib.berkeley.edu/Physics111/Reprints/LLS/11-HP3465A.pdf}{\textbf{HP 3465A DMM}} \textbf{(See Figure~\ref{fig:LLSimage_HP-3465A-DMM.jpg})}
    ...
    \item \href{http://physics111.lib.berkeley.edu/Physics111/Reprints/LLS/HM303-6_engl.pdf}{\textbf{HM303-6}} Oscilloscope \textbf{(See Figure~\ref{fig:LLSimage_Tektronix2215.jpg})} 
    ...
    \item \href{http://physics111.lib.berkeley.edu/Physics111/Reprints/LLS/09-DS345.pdf}{\textbf{SRS DS345}} Function Generator \textbf{(See Figure~\ref{fig:LLSimage_SRS_DS345.jpg})} \href{https://youtu.be/PrM8DHFOFS0}{Click here to watch an instructional video}
...
\begin{enumerate}
    ...
    \begin{itemize}
        \item To set the DS345 Digital Function Generator \textbf{(See Figure~\ref{fig:LLSimage_SRS_DS345.jpg})}:
        \begin{enumerate}
            \item Turn it on.
...
\checkpoint{Slope/Oct and Time Constant}{Explain where the pattern in the effective time constant is coming from. What do changes in the value of slope/oct and time constant do towards your measurement? Is the data an accurate representation of how the amplitude of input signal was changing?}
...
\checkpoint{Capacitive Noise}{Compare the magnitudes of the peaks in units of volts (not dBV). Explain why coiling the wire reduces the noise, why shielding the cable reduces it some more, and why grounding the shield reduces it even further.}
\\
...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item The data don't have many "periods". \textbf{WHY IS THIS A PROBLEM (this is a question for you to answer)?} The SAMPLE RATE may be too high. Decrease it, keeping in mind the trade-off with "spikiness", above.
