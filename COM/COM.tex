...
\signatures \hyperlink{Optimal Energy Range}{1} \hyperlink{Apparatus Safety}{2} \hyperlink{Data Collection}{3} \hyperlink{Radiation Flux}{4} \hyperlink{Over-the-Weekend Measurement}{5} 
...
\begin{enumerate}
    ...
    \item Now complete the Radiation Safety Training \href{http://experimentationlab.berkeley.edu/RadiationSafety}{\textbf{Radiation Safety}} \textbf{After completion of Training turn in all forms to \LabEngineer.}
...
\begin{itemize}
    \item \textbf{If you have any problems with the apparatus see \LabEngineer}
\end{itemize}
...
\begin{figure}[h]
    \centering
    \href{http://experimentationlab.berkeley.edu/sites/default/files/upimages/IMG_4768.JPG}{\includegraphics[width=0.37\linewidth]{images/Am241.JPG}}
    \caption{Am-241 Source in Place on its Holder}
    \label{Am241}
\end{figure}

\textbf{Remember: Only move the detector, not the source! Just change angles, etc.}
...
\checkpoint{Optimal Energy Range}{Why? What happens if your full scale energy range is too large or too small? How will you judge when you have obtained an appropriate range?}
...
\checkpoint{Apparatus Safety}{Stop! Call a GSI over and demonstrate your understanding of the apparatus and all the appropriate safety procedures you will follow when dealing with it.}
...
\begin{minipage}{.32\linewidth}
    \centering
    \href{http://experimentationlab.berkeley.edu/sites/default/files/upimages/IMG_4770.JPG}{\includegraphics[width=\linewidth,keepaspectratio]{images/apparatus.JPG}} \\
    \caption{Scattering Rod \\ and Detector}
\end{minipage} 
\end{figure}
...
\end{figure}  
	...
	\checkpoint{Data Collection}{Show the staff your setup for calibration. Erase any existing data in the program (the button to the right of the little traffic light in the toolbar). The staff will verify that data collection is working properly.}
    ...
    \checkpoint{Radiation Flux}{Show your calculations and your reasoning for your result above.}
    ...
    \begin{figure}[h]
        \centering
        \href{http://experimentationlab.berkeley.edu/sites/default/files/images/550px-COMimage013.jpg}{\includegraphics[width=0.67\linewidth]{images/550px-COMimage013.jpg}}
    ...
    \checkpoint{Over-the-Weekend Measurement}{It's very important that you understand what is going on here before the over-the-weekend measurement. Give a GSI an overview of the physics involved in the experimental setup and your plan for the following measurement.}
    
    %\textbf{Checkpoint: It's very important that you understand what is going on here before the over-the-weekend measurement. Give a GSI an overview of the physics involved in the experimental setup and your plan for the following measurement.} 
...
\newpage    
    ...
    \begin{figure}[h]
        \centering
        \href{http://experimentationlab.berkeley.edu/sites/default/files/images/550px-COMimage014.jpg}{\includegraphics[width=0.67\linewidth]{images/550px-COMimage014.jpg}}
