...
\signatures \hyperlink{Mean Electron Energy}{ 1} \hyperlink{Stable Plasma Flow}{ 2} \hyperlink{Valves and Probes}{ 3} \hyperlink{Shut Off the System Completely}{ 4} \hyperlink{Hall Electric Field vs. Magnetic Field Plots}{ 5} 
...
\checkpoint{Mean Electron Energy}{Discuss the following questions with you partner and once you feel you have a better understanding of what is happening, call over a GSI to sign you off:
...
\begin{enumerate}
    ...
    \item The gaussmeter, an oscilloscope (any scope with a 1M input will do), the gas supply cylinder (right side) and the \href{http://physics111.lib.berkeley.edu/Physics111/Reprints/HAL/sargent-welch\%201400\%20vacuum\%20pump.pdf}{vacuum pump} (under the bench) are the required components that are external to the Plasma Hall Effect rack.
...
\checkpoint{Stable Plasma Flow}{Discuss the following questions with you partner and once you feel you have a better understanding of what is happening, call over a GSI to sign you off: Establish a stable plasma flow by following one of the two techniques listed above. Which technique do you prefer to use at 30 Torr?}
...
\checkpoint{Shut Off the System Completely}{Discuss the following questions with you partner and once you feel you have a better understanding of what is happening, call over a GSI to sign you off:
Show you understand how to shut off the system completely and why it needs to be done that way. You do not have to turn off the system but simply supply your instructor with enough information to display you understand why we must take these safety precautions.}
...
\checkpoint{Hall Electric Field vs. Magnetic Field Plots}{Discuss the following questions with you partner and once you feel you have a better understanding of what is happening, call over a GSI to sign you off:
Show the your measurements of the Hall-voltage as a function of the magnetic field taken at various pressures and explain your results in the light of the above questions.}
