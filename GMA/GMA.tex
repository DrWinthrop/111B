...
\captionsetup{justification=centering}
\minipage[t]{0.33\textwidth}
  \href{http://experimentationlab.berkeley.edu/sites/default/files/images/GMAimagegeigercounter.jpg}{\includegraphics[width=\linewidth,keepaspectratio]{images/GMAimagegeigercounter.jpg}}
...
\begin{enumerate}
    ...
    \item Now complete the Radiation Safety Training \href{http://experimentationlab.berkeley.edu/RadiationSafety}{\textbf{Radiation\_Safety}} \textbf{After completion of Training turn in all forms to \LabEngineer.}
...
\begin{enumerate}
    ...
    \item Report any suspiciously high intensity of radiation to a GSI, Professor, or \LabEngineer as soon as possible.
\end{enumerate}
...
\checkpoint{Variable High--Voltage Supply}{What is the role of the variable high voltage and how does it affect the amplitude of the signal from the photomultiplier tube as observed with the oscilloscope?}
...
\begin{enumerate}
    ...
    \checkpoint{Width of a photopeak}{For a given radioactive sample (in a bottle), the emitted gamma rays are mono-energetic. What is the reason that we observe the peaks with finite width in the Pulse Height analyzer instead of delta functions?}
...
\begin{enumerate}
    ...
    \item E. Segre, ``\href{http://physics111.lib.berkeley.edu/Physics111/Reprints/GMA/Scattering\%20From\%20Center\%20appendix\%20a.pdf}{\textbf{Appendix A: Scattering from a Fixed Center of Force}}.'' \emph{Nuclei and Particles}, Second Edition, WA Benjamin Inc. London (1977).
    
    \item Y. Yoshizawa, ``\href{http://physics111.lib.berkeley.edu/Physics111/Reprints/GMA/betaandgammarayspecofCs137.pdf}{\textbf{Beta and Gamma Ray Spectroscopy of $^{137}$Cs,}}'' Nucl. Phys. {\textbf 5}, 122 (1958). \#QC770.N8
