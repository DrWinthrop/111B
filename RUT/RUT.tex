...
\begin{enumerate}
    ...
    \end{minipage} \hfill
        \begin{minipage}{0.49\linewidth}
        \href{http://experimentationlab.berkeley.edu/sites/default/files/images/ChamberInterior.JPG}{\includegraphics[height=0.8\linewidth]{images/ChamberInterior.JPG}}
...
\checkpoint{PN Detector}{Explain how the PN detector sends a signal to the computer. Also, without touching the PN detector, determine the solid angle of the detector. As stated below, the diameter is roughly 0.75 inches.}
...
\checkpoint{Signals}{Call a GSI or Professor over and show them all the signals you have found. Explain the signals.}
...
\checkpoint{Trial Run Analysis}{Show a GSI your analysis of your trial runs to check if you're doing the right thing.}
